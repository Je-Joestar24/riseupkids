    ...
    StarCamMission.findOne.mockReturnValue({
      ...
      lean: jest.fn().mockResolvedValue({
        ...
        vocab: [
          ...
          { displayText: 'Spoon', target: 'spoon', image: { url: '/spoon.png' }, audio: { url: '/spoon.mp3' }, introAudio: null, tryAgainAudio: { url: '/spoon-try.mp3' }, successAudio: { url: '/spoon-success.mp3' }, order: 7 },
        ],
      }),
    });
