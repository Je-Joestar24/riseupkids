 ...
 * - POST /reorder - Reorder explore content (admin only)
...
// Reorder explore content (admin only) - must be before /:id to avoid conflict
router.post('/reorder', authorize('admin'), reorderExploreContent);
